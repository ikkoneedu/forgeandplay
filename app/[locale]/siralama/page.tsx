...
export async function generateMetadata({
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `${SITE_URL}/${locale}/siralama`,
      languages: Object.fromEntries(LOCALES.map((l) => [l, `${SITE_URL}/${l}/siralama`])),
    },
    openGraph: { title: `${title} · ${SITE_NAME}`, description, url: `${SITE_URL}/${locale}/siralama` },
  };
}
